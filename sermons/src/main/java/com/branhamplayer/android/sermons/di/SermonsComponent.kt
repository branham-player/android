...
@Component(modules = [AuthenticationModule::class, DataModule::class, DrawerModule::class, ProfileModule::class, RoutingModule::class, RxJavaModule::class, SermonPlayerModule::class, SermonsModule::class])
